...
import { ItemDeleteDialogProps } from '@/types/crud-interface-types';
    ...
    <div className="space-y-5">
      <div className="bg-red-50 border border-red-200 rounded-lg p-4 flex gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="text-sm text-red-700">
            Estás a punto de eliminar <span className="font-semibold">"{itemName}"</span> de manera permanente. Esta acción no se puede deshacer.
          </p>
        </div>
      </div>
      ...
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 flex gap-3">
        ...
        <p className="text-sm text-yellow-800">
          Asegúrate de haber guardado cualquier información importante relacionada con esta {identity}.
        </p>
      </div>
